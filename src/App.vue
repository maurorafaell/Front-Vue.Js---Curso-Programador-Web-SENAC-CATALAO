<template>
  ...
  <header class="header">
    <img src="@/assets/catFire.png" alt="catFire" class="header-logo">      
  </header>
...
<br>
<footer class="footer">
  catFire. &copy; 2023 Todos os direitos reservados.
</footer>       
</template>
...
.bm-menu {
  ...
  top: 0;
  left: 0;
  background-color: #1e3b4db7; /* Black*/
