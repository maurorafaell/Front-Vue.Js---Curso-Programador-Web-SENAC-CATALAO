<template>
  ...
  export default {
    ...
    created() {
      ...
      axios.get(`apiwebsenac21.azurewebsites.net/cursos/${codigocurso}`).then(response => {
    ...
    methods: {
      submitForm() {        
        ...
        axios.put(`apiwebsenac21.azurewebsites.net/cursos/${codigocurso}`, this.curso).then(() => {
